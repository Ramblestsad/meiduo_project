...
from .views import statistical, users, specs, images, skus, orders, permission, groups, administrator
...
urlpatterns = [
    ...
    # --------administrator查询group路由--------
    re_path(r'^permission/groups/simple/$',
            administrator.AdministratorView.as_view({'get': 'simple'})),
]
...
# ------administrator路由------
router = DefaultRouter()
router.register('permission/admins', administrator.AdministratorView,
